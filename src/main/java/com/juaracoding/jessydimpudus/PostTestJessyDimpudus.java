package com.juaracoding.jessydimpudus;
...
public class PostTestJessyDimpudus {
    public static void main(String[] args) {
        ...
        delay(detik);
        driver.findElement(By.id("last-name")).sendKeys("Dimpudus");
        ...
        System.out.println("Select 2-4 years");
